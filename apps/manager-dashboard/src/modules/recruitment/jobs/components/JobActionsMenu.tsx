            ...
            {isOpen && (
                ...
                >
                    <button
                        ...
                        className="flex items-center gap-2 w-full px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 dark:hover:text-white rounded transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 w-full px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 dark:hover:text-red-300 rounded transition-colors"
                    >
